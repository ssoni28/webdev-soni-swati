...
var WidgetHeaderComponent = (function () {
    ...
    WidgetHeaderComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            if (params['widgetType']) {
                _this.pageId = params['widgetType'];
            }
    ...
    WidgetHeaderComponent.prototype.updateWidget = function () {
        if (this.widgetText === '' || this.widgetSize === '') {
            ...
            if (!this.widgetFlag) {
                var widget = new __WEBPACK_IMPORTED_MODULE_3__models_widget_model_client__["a" /* Widget */](this.widgetId, this.widgetType, this.pageId, this.widgetSize, this.widgetText, '', '');
...
var WidgetImageComponent = (function () {
    ...
    WidgetImageComponent.prototype.updateWidget = function () {
        if (this.widgetURL === '' || this.widgetWidth === '') {
            ...
            var widget = new __WEBPACK_IMPORTED_MODULE_1__models_widget_model_client__["a" /* Widget */](this.widgetId, this.widgetType, this.pageId, this.widgetSize, this.widgetText, '', '');
            if (!this.widgetFlag) {
                this.widgetService.createWidget(this.pageId, this.widget);
            }
            else {
...
var WidgetYoutubeComponent = (function () {
    ...
    WidgetYoutubeComponent.prototype.updateWidget = function () {
        if (this.widgetURL === '' || this.widgetWidth === '') {
            ...
            var widget = new __WEBPACK_IMPORTED_MODULE_1__models_widget_model_client__["a" /* Widget */](this.widgetId, this.widgetType, this.pageId, '', '', 'widgetWidth', 'widgetURL');
            if (this.widgetFlag) {
